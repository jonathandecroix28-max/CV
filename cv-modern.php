...
<head>
    ...
    <style>
        ...
        // on remplace les couleurs du thème sombre par des tons modernes
        $css = str_replace('#1e272e', '#2c3e50', $css);
        $css = str_replace('#0fbcf9', '#e74c3c', $css);
        $css = str_replace('background-color: #1e272e', 'background: linear-gradient(180deg, #2c3e50 0%, #34495e 100%)', $css);
        echo $css;
        ?>
    </style>
</head>
                    ...
                    <table class="initials-center-table">
                        <tr>
                            <td>
                                ...
                                <?php else: ?>
                                    <div style="font-size: 30px; color: #e74c3c;">
